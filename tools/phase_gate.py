...
PHASES: dict[str, dict[str, object]] = {
    ...
    "F12": {
        "f_codes": [],
        "tests": [
            "tests/api/test_chart_data.py",
            "tests/test_futures_grid_spacing.py",
            "tests/api/test_futures_grid_execution.py",
            "frontend/src/CandleChart.test.tsx",
            "frontend/src/i18n.test.tsx",
            "frontend/src/LanguageToggle.test.tsx",
            "frontend/src/BotWizard.test.tsx",
            "frontend/src/AdvancedTools.test.tsx",
            "frontend/src/FuturesPanel.test.tsx",
            "frontend/src/SignalPanel.test.tsx",
        ],
        "evidence": "evidence/F12/SONUC.md",
        "css_no_raw_colors": "frontend/src/styles.css",
        "sources": [
            "src/dcabot/server/api.py",
            "frontend/src/CandleChart.tsx",
            "frontend/src/i18n.tsx",
            "frontend/src/BotWizard.tsx",
            "frontend/src/FuturesPanel.tsx",
            "frontend/src/SignalPanel.tsx",
        ],
    },
    "F13": {
        "f_codes": [],
        "tests": [
            ...
            "tests/test_webhook_dedup_store.py",
            "tests/api/test_signals_webhook.py",
            "tests/api/test_signals_internal_intake.py",
            "tests/test_signal_native_indicators.py",
            "tests/api/test_signals_indicators.py",
        ],
        "evidence": "evidence/F13/SONUC.md",
        "sources": [
            "src/dcabot/server/api.py",
            "src/dcabot/application/tradingview_webhook.py",
            "src/dcabot/persistence/webhook_dedup_store.py",
            "src/dcabot/application/signal_native_indicators.py",
        ],
    },
    "F14": {
        "f_codes": [],
        "tests": [
            "tests/test_analytics_boundary.py",
            "tests/test_analytics_scores.py",
            "tests/test_embargo_window.py",
            "tests/test_combinatorial_purged_cv.py",
            "tests/test_overfitting_probability.py",
            "tests/test_sweep_orchestrator.py",
            "tests/test_trial_sampler.py",
            "tests/test_trial_registry.py",
        ],
        "evidence": "evidence/F14/SONUC.md",
        "sources": [
            "src/dcabot/analytics/scores.py",
            "src/dcabot/application/embargo_window.py",
            "src/dcabot/application/combinatorial_purged_cv.py",
            "src/dcabot/application/overfitting_probability.py",
            "src/dcabot/application/sweep_orchestrator.py",
            "src/dcabot/application/trial_sampler.py",
        ],
    },
}
