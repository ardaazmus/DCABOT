...
| 06_girdi | Verilen araştırma MD'sinin içerik kopyası ve [tek kanonik P1 Master Research FINAL promptu](06_girdi/P1_MASTER_RESEARCH_PROMPT_FINAL.md) |
...
`P1_MASTER_RESEARCH_PROMPT_FINAL.md`, dış araştırma için bu paketteki tek kanonik girdidir. Önceki `P1_Master_Research_Prompt_v2_LOCKED.md` dosyası tarihsel taslak olarak korunur ve kullanılmamalıdır. Mevcut rapor yalnız P1.07.d.3 kapsamını teslim eder; FINAL promptta istenen P1.05–P1.20 master klasörü henüz bu pakete eklenmiş sayılmaz.
