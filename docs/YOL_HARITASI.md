...
| P2.03 | Plain/conditional/koruyucu emir yaşamını test et | Fake/offline Spot LIMIT/MARKET lifecycle, guarded LIMIT → core `INTENT/FILL/ORDER_FINAL` binding, offline durable replay, redakte reconciliation association, fail-closed coordinator restart hydration, explicit authoritative snapshot gate, AttemptStore recovery orchestration ve bounded post-recovery lookup handoff `IMPLEMENTED_WITH_LIMITATION / LOCAL_PASS`; real signed REST/WS, conditional/order-list ve mutation `IN_PROGRESS/DEFERRED/NO-GO`. Kanıt: `evidence/P2.03/SONUC.md`, `evidence/P2.03/CORE_BINDING_SONUC.md`, `evidence/P2.03/DURABLE_BINDING_SONUC.md` |
| P2.04 | Restart, WS/REST reconciliation ve operasyon kontrolleri | Offline Fake WebSocket/Fake REST restart, duplicate/conflict, out-of-order, UNKNOWN, GAP, STALE, reset, disagreement, redakte durable observation, cursor hydration, authoritative snapshot sınırları, AttemptStore recovery orchestration ve bounded post-recovery lookup handoff `IMPLEMENTED_WITH_LIMITATION / LOCAL_PASS`; gerçek User Data Stream, signed REST, live recovery ve mutation `IN_PROGRESS/DEFERRED/NO-GO`. Kanıt: `evidence/P2.04.c/SONUC.md`, `evidence/P2.03/P2.04_OFFLINE_ACCEPTANCE_SONUC.md`, `evidence/P2.03/DURABLE_BINDING_SONUC.md` |
